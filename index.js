...
const showMenu = () => {
  ...
  console.log('                ');
  console.log('【[32m1[32m】 [33m[1m Iniciar ataque DDoS');
  console.log('【[32m2[32m】 [33m[1m Actualizar código');
  console.log('【[32m3[32m】 [33m[1m Configurar conexiones simultanea');
  console.log('【[32m4[32m】 [33m[1m Aumentar potencia del ataque');
  console.log('【[32m5[32m】 [33m[1m Sacar información de IP');
  console.log('【[32m6[32m】 [33m[1m Análisis de IP');
  console.log('【[32m7[32m】 [33m[1m Información geográfica de IP');
  console.log('【[32m8[32m】 [31m[1m Salir');
  console.log('               ');
  rl.setPrompt('[37m[1m  🌐➤ ');
  rl.prompt();
};
