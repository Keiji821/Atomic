...
console.log('[36m ⸂⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⸃');
console.log('[36m ︳1. Iniciar ataque DDoS');
console.log('[36m ︳2. Actualizar código desde GitHub');
console.log('[36m ︳3. Configurar conexiones simultaneas');
console.log('[36m ︳4. Aumentar potencia del ataque');
console.log('[36m ︳5. Salir');
console.log('[36m ⸌⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⸍');
