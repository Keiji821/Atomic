...
const showMenu = () => {
  ...
  console.log('                ');
  console.log('[32m【1[32m】 [33m[1m Iniciar ataque DDoS');
  console.log('[32m【2[32m】 [33m[1m Actualizar código');
  console.log('[32m【3[32m】 [33m[1m Configurar conexiones simultanea');
  console.log('[32m【4[32m】 [33m[1m Aumentar potencia del ataque');
