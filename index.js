...
const showMenu = () => {
  ...
  console.log('[36m ⸂⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⎺⸃');
  console.log('[33m[1m ︳[32m【1[32m】 [33m[1m Iniciar ataque DDoS                ︳');
  console.log('[33m[1m ︳[32m【2[32m】 [33m[1m Actualizar código                  ︳');
  console.log('[33m[1m ︳[32m【3[32m】 [33m[1m Configurar conexiones simultaneas  ︳');
  console.log('[33m[1m ︳[32m【4[32m】 [33m[1m Aumentar potencia del ataque       ︳');
  console.log('[33m[1m ︳[32m【5[32m】 [33m[1m Sacar información de IP            ︳');
  console.log('[33m[1m ︳[32m【6[32m】 [33m[1m Análisis de IP                     ︳');
  console.log('[33m[1m ︳[32m【7[32m】 [33m[1m Información geográfica de IP       ︳');
  console.log('[33m[1m ︳[32m【8[32m】 [31m[1m Salir                              ︳');
  console.log('[36m ⸌⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⎽⸍');
  rl.setPrompt('[37m[1m  🌐➤ ');
  rl.prompt();
};
